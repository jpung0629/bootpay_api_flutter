...
class BootpayApi {
  static const MethodChannel _channel =
      const MethodChannel('bootpay_api');
  ...
  static Future<void> request(BuildContext context, Payload payload, {User user, List<Item> items, Extra extra,
    StringCallback onDone, StringCallback onReady, StringCallback onCancel, StringCallback onError}) async {
    payload.applicationId = Platform.isAndroid ? payload.androidApplicationId : payload.iosApplicationId;
